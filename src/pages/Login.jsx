    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-[32px] border border-white/10 bg-white/5 p-10 shadow-glow">
        <div className="mb-8 text-center">
          <h1 className="text-3xl font-semibold text-text">Sign in to CODEBASE</h1>
          <p className="mt-2 text-sm text-secondary">Secure your DSA insights and start analyzing problem solutions.</p>
        </div>
